...
/// <summary>
/// Prozessweiter, beobachtbarer Zwischenspeicher für den zuletzt abgerufenen Datenstand eines
/// Slices. Der Background-Service schreibt, die Tiles lesen und abonnieren <see cref="Changed"/>
/// für Push-Aktualisierung ohne Reload.
/// </summary>
/// <remarks>
/// Bewusst ein beobachtbarer Singleton statt <c>IMemoryCache</c>: In Blazor Server braucht es
    ...
    where TSnapshot : class, ISnapshot
{
    ...
    public void Update(TSnapshot snapshot)
    {
