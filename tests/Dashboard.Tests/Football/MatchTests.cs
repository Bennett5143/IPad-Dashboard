...
public class MatchTests
{
    private static Match Played(int own, int opp) =>
        new(new DateTimeOffset(2026, 5, 20, 15, 0, 0, TimeSpan.Zero), "La Liga", "Gegner", true, own, opp);
    ...
    public void Outcome_IsNull_WhenNotFinished()
    {
        var fixture = new Match(
            new DateTimeOffset(2026, 6, 1, 19, 0, 0, TimeSpan.Zero), "La Liga", "Gegner", false, null, null);
